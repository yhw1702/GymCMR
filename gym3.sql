...
drop table registrationtbl;
drop table membertbl;
drop table programtbl;
...
-- 임시 데이터 삽입
-- 멤버 테이블
insert into membertbl values ( null, '윤현우', '01011112222', 'A', '101');
insert into membertbl values ( null, '이연호', '01033334444', 'B', '501');
insert into membertbl values ( null, '이동준', '01044445555', 'A', '101');

-- 프로그램 테이블
insert into programtbl values (null, '헬스', '월,수,금','오전','12');
insert into programtbl values (null, '헬스', '월,수,금','오후','10');
insert into programtbl values (null, '요가', '화,목,토','오전','8');
